...
- 修改公共 profile、Thrift 语义或 unsupported 列表先评估三仓影响；发布回执模拟：`npm run test:release`；[稳定发行](docs/releases/unreleased/2026-09-11-ci-stable-publication.md)、[只读回读与恢复](docs/releases/unreleased/2026-09-11-ci-release-readback.md)，后续问题见 [TODO](TODO.md)。
